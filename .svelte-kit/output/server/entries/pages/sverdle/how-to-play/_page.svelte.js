...
//#region src/routes/sverdle/how-to-play/+page.svelte
function _page($$renderer) {
	head("awtuxs", $$renderer, ($$renderer) => {
		$$renderer.title(($$renderer) => {
			$$renderer.push(`<title>How to play Sverdle</title>`);
		});
		$$renderer.push(`<meta name="description" content="How to play Sverdle"/>`);
	});
